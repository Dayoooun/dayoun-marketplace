...
이 스킬은 **사업계획서 10단계의 일부가 아닙니다.** 10단계 하네스 안에서는 호출하지 않고, 승인된 사업정보를 다른 실무 문서로 정리할 때만 선택적으로 사용합니다. 이 스킬은 학습자의 스타터 워크스페이스 `.agents/skills`와 `.claude/skills`에 함께 들어 있지만 **강의 커리큘럼에는 포함되지 않습니다.**
