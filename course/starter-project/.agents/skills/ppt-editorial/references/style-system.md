...
After one style direction is confirmed, do one short reverse-engineering pass on the selected `표지 / 목차 페이지 / 본문 페이지` before writing planning files or generating final visuals.
